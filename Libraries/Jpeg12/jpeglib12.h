...
#define jpeg_memory_src                jpeg12_memory_src
#define jpeg_memory_dest			   jpeg12_memory_dest
...
EXTERN(void) jpeg_memory_src JPP((j_decompress_ptr cinfo, char *pSourceBuffer, unsigned long nBytesInSourceBuffer));
EXTERN(void) jpeg_memory_dest JPP((j_compress_ptr cinfo, char **ppDestinationBuffer));
