...
; Install a fake standard file, so that BViewer will function in the absence of an installed set of ILO standards.
Source: "FakeStandard.png"; DestDir: "{code:ProgramData}\BViewer\Standards"; DestName: "DemoStandard.png"; Attribs: readonly; Flags: onlyifdoesntexist uninsneveruninstall
